            ...
            <div class="intro-right">
                ...
                <div class="number">
                    ...
                    <div class="number-cont">
                        ...
                        <input type="number" v-model="num" max="99" min="1" id="numberinput"/>
...
export default {
    ...
    methods:{
        addcart(){
            var url="http://127.0.0.1:3000/addcart?cid="+this.list[0].id+"&count="+this.num+"&title="+this.list[0].title+"&img="+this.list[0].img_url+"&color="+this.colorc+"&price="+this.list[0].price;
